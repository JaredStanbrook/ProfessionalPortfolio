        ...
        <main id="content" className="pt-24 lg:w-1/2 lg:py-24">
          ...
          >
            ...
            <div>
              ...
              <p className="mb-4">
                For as long as I can remember, I've been deeply immersed in the
                world of computing, driven by a profound curiosity for its
                technical intricacies.
              </p>
              <p className="mb-4">
                My journey began with Python coding, sparking a passion that led
                me to explore various programming languages and delve into
                domains like game development, web development, and data
                analysis throughout high school.
              </p>
              <p>
                Now, with a university degree shaping my focus on networking and
                security, my interests have converged on web development, where
                I continue to deepen my knowledge and skills.
              </p>
            </div>
          </section>
          <section
                  ...
                  <Card>
                    <CardContent>
                      <CardTitle href="/about">
                        IT Service Desk Portal | Website
                      </CardTitle>
                      <CardDescription>
                        This website was developed to address the unique needs
                        of our student-run support desk, enhancing efficiency by
                        digitising client records and feedback forms to
                        streamline service and improve customer support.
                      </CardDescription>
                ...
                <li className="mb-12">
                  <Card>
                    <CardContent>
                      ...
                      <CardDescription>
                        I developed My Own Business System to cater specifically
                        to my needs as an independent disability support worker,
                        streamlining the process of creating invoices.
                      </CardDescription>
                      <CardFooter>
                ...
                <li className="mb-12">
                  <Card>
                    <CardContent>
                      ...
                      <CardDescription>
                        This website was developed for the purpose of displaying
                        my achievements and digitally represent my passion for
                        technology.
                      </CardDescription>
                      <CardFooter>
                        <CardItem>Typescript</CardItem>
